...
<?php
    ...
    // 시간표 api 받아오기
    $URL = "https://open.neis.go.kr/hub/hisTimetable?KEY=02d0a0a89fd346cf8c979f7fb1c50cd0&Type=json&ATPT_OFCDC_SC_CODE=$ScCode&SD_SCHUL_CODE=$SdCode&ALL_TI_YMD=$date&GRADE=$grade&CLASS_NM=$class";
    ...
    $URL = "https://open.neis.go.kr/hub/mealServiceDietInfo?KEY=02d0a0a89fd346cf8c979f7fb1c50cd0&Type=json&ATPT_OFCDC_SC_CODE=$ScCode&SD_SCHUL_CODE=$SdCode&MLSV_YMD=$date";
    $snoopy = new Snoopy; // snoopy 생성
    $snoopy->fetch($URL);
    $return = json_decode($snoopy->results);
